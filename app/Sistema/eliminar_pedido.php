...
<td ><img src="../images/blank.gif" alt="" style="display: block;" height="18" width="18"></td></tr>
  ...
  <tr> 
    ...
    <tr></form>
       <td align="center"><form action="cancelar_pedido.php?id_pedido='.$codigo_pedido.'" method="post"><td align="center"><input name="cancelar"  type="image" onMouseOver= src="images/ep1.gif" onMouseMove= src="images/ep1.gif" onMouseOut=src="images/ep2.gif" value="" SRC="images/ep2.gif"> </td> </form>
    </tr>
  </table>
...
<p align="center"><a href="modificar_pedido.php">VOLVER ATRAS</a></p>
