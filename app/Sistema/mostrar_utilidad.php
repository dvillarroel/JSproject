...
<br>
<form action="utilidad_periodo.php" method="post" name="ventas" onSubmit="return Validar()">
  <div align="center"><font color="#330000" size="4" class="titl">UTILIDAD POR 
    PERIODO DE TIEMPO</font><br>
    <br>
  </div>
