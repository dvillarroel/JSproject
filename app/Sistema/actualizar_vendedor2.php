<link href="hoja_de_estilo.css" type="text/css" rel="stylesheet">
			...
			<div align="center">
			  <p><font color="#330000" size="4" class="titl">RESULTADO DE LA BUSQUEDA</font><br>
...
<?php
	...
	if($tipo == 1)
	{
		...
		else
		{
			...
			header ("Location:buscar_vendedor.php?error=2");
			exit;
	...
	{	
		...
		{
				heer ("Location:buscar_vendedor.php?error=3");
				exit;
	...
	if($tipo == 3)
	{
		...
		{	
				heer ("Location:buscar_vendedor.php?error=4");
				exit;
		}	
...
';
	...
	if (mysql_num_rows($usuario_consulta) == 0)
	{
		...
		$usuario_consulta = mysql_query("insert into venta values($nc, $codigo_cliente, 0,0,'$fecha','No Ejecuto');" );	
  ...
  <tr> 
	...
	//echo 'hola2';
		...
		{	
			    ...
			    <td class="title">Total Descuento</td>
...
<p align="center"><a href="principal_target.php">VOLVER A LA PAGINA PRINCIPAL</a></p>
    ...
    <tr></form>
      <td align="center"><a href="seleccionar_producto.php?id_cliente='.$codigo_cliente.'&id_pedido='.$codigo_pedido.'&id_pagina=buscar_cliente_pedido21.php">(+)Añir Productos</a> </td>
        		<td align="center">
...
echo '<br><table width="20%" border="0" align="center" >
    <tr>
      <td align="center"><a href="solicitud_pedido-all.php?id_cliente='.$codigo_cliente.'&id_pedido='.$codigo_pedido.'&fecha='.$fecha_pedido.'" TARGET="_blanc">Generar Solicitud</a> </td>
	  </tr> </table>';
