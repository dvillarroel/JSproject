...
';
    ...
    <td class="title">Registrar Equipo Propio </td>
    <td class="title">Asignar Equipo</td>
	...
	for ( $i=0; $i< cuantos_registros_bd($usuario_consulta); $i++)
	{
		...
		echo "
    			...
    			<td class='campotablas'><a href=registrar_equipo_cliente.php?id=".$registro['codigo_cliente'].">Registrar </a></td>
				<td class='campotablas'><a href=registrar_equipo.php?id=".$registro['codigo_cliente'].">Asignar </a></td>	";
