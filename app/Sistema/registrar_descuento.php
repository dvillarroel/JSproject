...
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td class="panel-titulo3" width="100%" align="center"><font class="titulo_formulario"> 
      REGISTRAR DESCUENTO</font></td>
    <td class="panel-titulo"><img src="../images/blank.gif" alt="" style="display: block;" height="18" width="16"></td>
  </tr>
</table>
<form action="registrar_descuento2.php?id=<? echo $_GET['id'] ?>" method="post" name="ventas">
	...
	$fecha=$registro7['date'];
		...
		?>
            ...
            <tr> 
              ...
              <td class="campotablas"><select name="menu1" class="Seleccion"  >

  <option>Retraso</option>
  <option>Faltas</option>
  <option>Otros Descuentos (Ver Observacion)</option>
</select>
</td>
            </tr>
            <tr> 
...
<table width="30%" border="0" align="center" >
    <tr>
      ...
      <form action="listar_empleados_adelanto2.php" method="post"><td align="center"><input name="cancelar"  type="image" onMouseOver= src="images/c2.gif" onMouseMove= src="images/c2.gif" onMouseOut=src="images/c1.gif" value="" SRC="images/c1.gif"> </td> </form>
    </tr>
  </table>
