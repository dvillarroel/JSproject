...
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td class="panel-titulo3" width="100%" align="center"><font class="titulo_formulario"> 
      MODIFICAR CARGO EN LA EMPRESA</font></td>
...
<table width="50%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFCC" bgcolor="#E4E4E4" style="TABLE-LAYOUT: fixed">
            ...
            <tr> 
              ...
              <td class="campotablas"><input type="text" name="cargo"  tabindex="3" class="Formulario" value=<? echo $a['cargo'];?> > 
              </td>
            </tr>
            <tr> 
              <td height="27"class="campotablas"> Descripcion:</td>
              <td class="campotablas"> <input type="text" name="descripcion"  maxlength="25" tabindex="5" class="Formulario" value=<? echo $a['descripcion'];?>> 
              </td>
            </tr>
            <tr> 
              <td class="campotablas">Sueldo Basico:</td>
              <td class="campotablas"> <input type="text" name="sueldo_basico"  tabindex="3" class="Formulario" value=<? echo $a['sueldo_basico'];?>></td>
            </tr>
            <tr> 
              <td class="campotablas">Sueldo Antiguedad:</td>
              <td class="campotablas"><input type="text" name="sueldo_ant"  tabindex="3" class="Formulario" value=<? echo $a['antiguedad'];?>></td>
            </tr>
            <tr> 
              <td class="campotablas">Otros:</td>
              <td class="campotablas"><input type="text" name="otros"  tabindex="3" class="Formulario" value=<? echo $a['otros'];?>></td>
            </tr>
            <tr> 
              <td class="campotablas">Descuentos:</td>
              <td class="campotablas"><input type="text" name="descuentos"  tabindex="3" class="Formulario" value=<? echo $a['descuentos'];?>></td>
            </tr>
            <tr>
              <td class="campotablas">Observaciones</td>
              <td class="campotablas"><input type="text" name="observaciones"  tabindex="3" class="Formulario" value=<? echo $a['observaciones'];?>></td>
            </tr> 
          </table> 
...
<table width="30%" border="0" align="center" >
    <tr>
      ...
      <form action="listar_cargos.php" method="post"><td align="center"><input name="cancelar"  type="image" onMouseOver= src="images/c2.gif" onMouseMove= src="images/c2.gif" onMouseOut=src="images/c1.gif" value="" SRC="images/c1.gif"> </td> </form>
    </tr>
  </table>
