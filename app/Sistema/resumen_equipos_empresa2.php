...
<table width="50%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFCC" bgcolor="#E4E4E4" style="TABLE-LAYOUT: fixed">
          ...
          <tr> 
			...
			//echo "SELECT total_base, total_botellon FROM equipos_empresa where codigo_ee=1";			

			$resultado2= consulta_bd("SELECT total_base, total_botellon FROM equipos_empresa where codigo_ee=1");
			
			$a2=sacar_registro_bd($resultado2);
...
<td class="border-bright"><img src="../images/blank.gif" alt="" style="display: block;" height="18" width="18"></td></tr>
  ...
  <br>
<p align="center"><a href="equipos_empresa.php">Regresar Administrar Equipos</a></p>
