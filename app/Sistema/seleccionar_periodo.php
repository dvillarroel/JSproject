...
<br>
<form action="listar_clientes_inactivos.php" method="post" name="ventas" onSubmit="return Validar()">
  <div align="center">
    <p><font color="#330000" size="4" class="titl">Periodo de Inactividad de los 
      Clientes </font></p>
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFCC" bgcolor="#E4E4E4" style="TABLE-LAYOUT: fixed">
          ...
          <td width="80%" class="campotablas"><input type="text" name="correo_electronico" id="correo_electronico3" maxlength="20" tabindex="8" class="Formulario" value=<? echo $fecha ?> readonly="true"/> 
            ...
            <tr> 
              <td height="60" colspan="2"class="campotablas"><div align="center"> 
                  <input name="image"  type="image" onMouseOver= src="images/bu1.gif" onMouseMove= src="images/bu1.gif" onMouseOut=src="images/bu2.gif" value="" SRC="images/bu2.gif" align="middle"></form>
                </div></td>
</tr> <tr> <td height="60" colspan="2"class="campotablas"><div align="center"> 
<form action="listar_clientes_inactivos.php" method="post" > <input name="image2"  type="image" onMouseOver= src="images/15dias.gif" onMouseMove= src="images/15dias.gif" onMouseOut=src="images/15dias2.gif" value="" SRC="images/15dias2.gif" align="middle"></div></td>
            </tr>
          </table>
