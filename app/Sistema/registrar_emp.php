...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFCC" bgcolor="#E4E4E4" style="TABLE-LAYOUT: fixed">
			...
			conectar_bd();
			$resultado= consulta_bd("SELECT max(id_empleado) as p FROM empleados" );
	...
	$fecha=$registro7['date'];
			...
			echo ' <input type="text" name="codigo_cliente" maxlength="15" readonly="true" tabindex="1" class="Formulario" value='.$nc.'>'; ?>
              </td>
              <td width="25%" class="campotablas">Nombre Empleado:</td>
              <td width="25%" class="campotablas"><input type="text" name="nombre_empleado" maxlength="7" tabindex="2" class="Formulario"> 
              </td>

            </tr>
            <tr> 
              <td class="campotablas">Apellidos Empleado:</td>
              <td class="campotablas"><input type="text" name="apellidos" maxlength="15" tabindex="3" class="Formulario"> 
              </td>
              <td class="campotablas">Direccion Empleado:</td>
              <td class="campotablas"><input name="direccion" type="text" class="Formulario" tabindex="4" maxlength="17"  > 
              </td>
            </tr>
            <tr> 
              <td height="27"class="campotablas"> Telefono:</td>
              <td class="campotablas"> <input type="text" name="telefono"  maxlength="25" tabindex="5" class="Formulario"> 
              </td>
