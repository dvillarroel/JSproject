<?php
	...
	$montoPagadoT=$montopagado+$monto_pago;
	
	require_once("manejomysql.php");
	conectar_bd();
	
	if($monto== $montoPagadoT)
	{		$resultado7=consulta_bd("SELECT CURRENT_DATE as date" );
		...
		consulta_bd("INSERT INTO PAGO_PEDIDOS VALUES ($codigo, $cod_pedido, 1, $monto_pago, $montoPagadoT,'$fecha','si')");
	...
	else
	{
		...
		consulta_bd("INSERT INTO PAGO_PEDIDOS VALUES ($codigo, $cod_pedido, 1, $monto_pago, $montoPagadoT, '$fecha', 'No')");
