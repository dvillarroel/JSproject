...
<br>
<form action="egreso_periodo.php" method="post" name="ventas" onSubmit="return Validar()">
  <div align="center"><font color="#330000" size="4" class="titl">Gasto Operativos</font><br>
    <br>
  </div>
...
<table width="30%" border="0" align="center" >
    ...
    <td align="center">&nbsp; </td>
	  ...
	  <p align="center"><a href="egresos.php">VOLVER ATRAS</a></p>
