...
<body background="body2.jpg"><br>
		  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    		<tr> 
    			<td colspan="9" class="title"><div align="center">LISTA DE PEDIDOS REGISTRADOS</div></td>
  				</tr>
  				<tr > 
			    ...
			    <td class="title">Modificar Pedido</td>
				...
				for ( $i=0; $i< cuantos_registros_bd($usuario_consulta); $i++)
				{
					...
					echo "
		    			...
		    			<td class='campotablas'><a href=ver_pedido.php?id_pedido=".$cod_pedido."&id_cliente=".$codigo_cliente.">Ver Detalle Pedido </a></td>
						<td class='campotablas'><a href=modificar_pedido2.php?id_pedido=".$cod_pedido."&id_cliente=".$codigo_cliente."&id_tipo=Codigo_Cliente>Modificar</a></td>
						<td class='campotablas'><a href=eliminar_pedido.php?id_pedido=".$cod_pedido."&id_cliente=".$codigo_cliente."&id_tipo=Codigo_Cliente>Cancelar Pedido</a></td>";
