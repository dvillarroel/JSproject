...
<body>
<p><div align="center">INFORMACION CLIENTE</div></p>
...
<td ><img src="../images/blank.gif" alt="" style="display: block;" height="18" width="18"></td></tr>
  ...
  <tr> 
	...
	$usuario_consulta = mysql_query("SELECT cantidad, monto, precio_unitario, cod_dp, cod_producto, cod_equipo FROM detalle_pedido WHERE cod_pedido=".$cod_pedido);	
		...
		<tr>
      		<td class="title">Seleccionar Empleado que realizo la entrega</td>
		</tr>
		<tr>
      		<td class="campotablas"><form action="registrar_entrega_pedido2.php?id_pedido='.$codigo_pedido.'" method="post">';
    ...
    <tr>
		<td align="center"><input name="cancelar"  type="image" onMouseOver= src="images/rp2.gif" onMouseMove= src="images/rp2.gif" onMouseOut=src="images/rp.gif" value="" SRC="images/rp.gif"> </td> </form>
    </tr>
 </table>
		<table width="60%" border="0" align="center" >
    <tr></form>
       <td align="center"><p align="center"><a href="registrar_entrega_pedido.php">VOLVER ATRAS</a></p>
