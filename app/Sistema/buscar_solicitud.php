...
';
	...
	<td class="campotablasSP2" >Registro</td>
  	</tr>';
		...
		echo "
    			...
    			<td class='campotablas'><a href=buscar_cliente_solicitud.php?menu1=1&buscar=".$registro['codigo_cliente'].">Registrar Solicitud</a></td>";
		echo "</tr>";
		...
		echo "</table>";
		echo '<p>&nbsp;</p>
<p align="center"><a href="registrar_anticipo_pedido.php">VOLVER ATRAS</a></p>
