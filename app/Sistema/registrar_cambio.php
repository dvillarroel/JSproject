...
echo '<form action="registrar_cambio2.php?id='.$id_c.'" method="post">';
echo'
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFCC" bgcolor="#E4E4E4" style="TABLE-LAYOUT: fixed">
            <tr> 
              <td colspan="4"  class="title">INFORMACI&Oacute;N REQUERIDA</td>
            </tr>
            <tr> 
	...
	$fecha=$registro7['date'];
            ...
            <tr> 
              <td class="campotablas">Seleccionar tipo de Equipo:</td>
              <td class="campotablas"> <select name="nombres" class="Seleccion"> 
			  <option>Botellon de Agua</option>
			  <option>Base de equipo de agua</option>
